...
export CURRENT_NETLIST='./results/synthesis/cpu_axi_top.v';
...
export PACKAGED_SCRIPT_0='nix/store/n0wqr3jrpjlfdqdp3gnlpfhn2m0n0mkp-openlane1-1.1.1/bin/scripts/openroad/ioplacer.tcl';
